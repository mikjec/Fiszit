<x-app-layout>
    <div
                            ...
                            <li class="bg-gray-100 m-2 rounded-lg">
                                <div class="m-4 p-4 flex justify-between items-center">
                                    ...
                                    <div class="flex gap-4 mt-2 items-center">
                                        <button @click="openEdit({{ $deck->id }}, '{{addslashes($deck->name)}}')" class="hover:text-[#00ff00] transition-colors duration-100"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <div
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg min-w-[300px] relative" x-show="!confirmation">
                <button
                    class="absolute top-4 right-4 hover:text-gray-500"
                    @click="open = false">✕</button>

                <h2 class="text-lg font-semibold mb-4"
                    x-text="deckId ? 'Edytuj zestaw' : 'Dodaj zestaw'">
                </h2>
                ...
                <form
                    ...
                    <div class="flex justify-end mt-6">
                        <button
                            type="submit"
                            class="px-4 py-3 bg-[#9ce4ff] text-white rounded-md"
