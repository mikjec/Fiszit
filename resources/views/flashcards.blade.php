    ...
    <div
        ...
        <x-slot name="header">
            <div class="flex flex-row justify-between items-center mb-4">
                <h2 class=" font-semibold text-[1rem] md:text-[1.3rem] text-gray-800 leading-tight">
                    {{$deck->name }}
                </h2>
            ...
            <div class="flex flex-row " x-data="{
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center">
                    <form method="POST" action="{{ route('decks.unshare', $deck) }}">
                        @csrf
                        <button class="bg-[#bdbdbd] hover:bg-[#989898] text-white px-4 py-2 rounded mb-3 md:mb-0 me-3">
                            Nie udostępniaj
                        </button>
                    </form>
                    <div class="flex flex-row items-center">
                        <input
                            ...
                            x-ref="link"
                            class="border rounded px-3 py-2 md:min-w-[400px]">
                        <button @click="copyLink($refs.link.value)" class="ms-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 0 1-.75.75H9a.75.75 0 0 1-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 0 1 1.927-.184" />
                            </svg>
                        </button>
                        <span x-show="copied" class="text-[#9cf]">
                ...
                <form method="POST" action="{{ route('decks.share.generate', $deck) }}">
                    @csrf
                    <button class="bg-[#9cf] hover:bg-[#89b6e4] text-white px-4 py-2 rounded">
                        Udostępnij
                    </button>
                </form>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-center text-gray-400 mb-4">
                <span>lub zaimportuj z pliku CSV</span>
            </div>
            <div>
            ...
            <div class="w-full flex flex-col justify-center items-center">
                ...
                <div class="flex flex-col lg:flex-row justify-between"
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-gray-100 px-4 py-4 w-[300px] h-[200px] m-4 focus-within:ring-2 focus-within:ring-indigo-100 transition-all md:w-[350px] md:h-[250px]"
                        ...
                        <textarea
                            class="w-full h-[80%] resize-none border-none p-0 focus:ring-0 text-gray-700 leading-relaxed placeholder:text-gray-300 text-[1.2rem] md:text-[1.4rem]"
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 px-4 py-4 w-[300px] h-[200px] md:w-[350px] md:h-[250px] m-4 focus-within:ring-2 focus-within:ring-indigo-100 transition-all"
                        x-data="{
                                        value: @js($card->back),
